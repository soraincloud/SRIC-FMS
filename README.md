...
> 后续可能会更新文件上传 在此之前 你可能需要手动管理你的文件
...
提供的数据库文件中有部分示例数据 你可以选择删除他们

菜单的显示由 "菜单管理模块" 配置 你可以在管理页面找到它

初始默认管理员账户为 soraincloud soraincloud 你也可以在配置完成后自己注册管理员账户 并且将其管理权限修改为 1

> 注意 管理权限由上至下为 1 - 9 等级

后端接口的访问由 "接口管理模块" 配置 你可以在管理页面找到它

系统预留了二次开发的空间 并且提供了简单的框架体系 你可以将它更新为自己的私有个人系统
